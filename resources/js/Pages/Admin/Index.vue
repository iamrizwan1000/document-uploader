...
const subNavigation = [
    // { name: 'Category', href: route('owner.category'), icon: AdjustmentsIcon, current: true },
    // { name: 'Size', href: route('owner.size'), icon: ArrowsExpandIcon, current: false },
    // { name: 'Color', href: route('owner.color'), icon: ArrowCircleLeftIcon, current: false },
